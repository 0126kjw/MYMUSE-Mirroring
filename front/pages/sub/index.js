...
const markers = [
    ...
    { markerOffset: 15, name: "중", coordinates: [126.996, 37.570] },
    ...
    { markerOffset: 15, name: "은평", coordinates: [126.930, 37.630] },
    ...
    return <>
        ...
        <Marker key={name} coordinates={coordinates}>
          ...
          <text
            textAnchor="middle"
            y={markerOffset}
            style={{ fontFamily: "system-ui", fontSize:'8', fontWeight:'bold'}} // fill:'black', <= text color
          >
            {name}
          </text>
        </Marker>
