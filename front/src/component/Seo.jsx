...
const Seo = ({ pagePath, pageTitle, pageDosc }) => {
	const appName = `MYMUSE ${pagePath}`;
	const ogUrl = process.env.NEXT_PUBLIC_TEST_URL + pagePath;
	return (
		<Head>
			<meta name='viewport' content='width=device-width, initial-scale=1.0' />
			<link rel='canonical' href='http://www.mysite.com/article/article1.html' />
			<meta name='keywords' content='박물관, 전시관, 미술관' />
			<meta name='description' content={pageDosc} />
			...
			<meta property='og:description' content={pageDosc} />
			...
			<meta name='twitter:description' content={pageDosc} />
